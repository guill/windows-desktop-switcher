...
switchConditional(desktopNumber) {
    if (GetKeyState("Shift", "P")) {
        global CurrentDesktop
        prevDesktop := CurrentDesktop
        MoveCurrentWindowToDesktop(desktopNumber)
        switchDesktopByNumber(prevDesktop)
    } else {
...
CapsLock & 1::switchConditional(1)
CapsLock & 2::switchConditional(2)
CapsLock & 3::switchConditional(3)
CapsLock & 4::switchConditional(4)
CapsLock & 5::switchConditional(5)
CapsLock & 6::switchConditional(6)
CapsLock & 7::switchConditional(7)
CapsLock & 8::switchConditional(8)
CapsLock & 9::switchConditional(9)
...
CapsLock & Esc::switchDesktopToLastOpened()

CapsLock & h::Send {LAlt down}{RAlt down}{RAlt up}{Tab down}{Tab up}{LAlt up}
CapsLock & l::Send {LAlt down}{RAlt down}{RAlt up}{LShift down}{Tab down}{Tab up}{LShift up}{LAlt up}
CapsLock & j::Send {LAlt down}{RAlt down}{RAlt up}{Tab down}{Tab up}{LAlt up}
CapsLock & k::Send {LAlt down}{RAlt down}{RAlt up}{LShift down}{Tab down}{Tab up}{LShift up}{LAlt up}
